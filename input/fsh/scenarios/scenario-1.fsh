// Patient under 65 on NSAID, and not prescribed gastroprotective drug
Instance: patient-1-28y-NSAID-nogastro-bundle
InstanceOf: Bundle
Usage: #example
* meta
  * tag = #testcase
...
* entry[+]
  * fullUrl = "#patient-1-28y-NSAID-nogastro"
  * resource = patient-1-28y-NSAID-nogastro
  * request
    * method = #PUT
    * url = "Patient/patient-1-28y-NSAID-nogastro"
* entry[+]
  * fullUrl = "#patient-1-28y-NSAID-nogastro-medicationrequest-1"
  * resource = patient-1-28y-NSAID-nogastro-medicationrequest-1
  * request
    * method = #PUT
    * url = "MedicationRequest/patient-1-28y-NSAID-nogastro-medicationrequest-1"

Instance: patient-1-28y-NSAID-nogastro
InstanceOf: Patient
* identifier
  * system = "http://cds.optum.com/fhir/test-cases|0.1.0"
  * value = "patient-1-28y-NSAID-nogastro"
* name
  * family = "TEST"
  * given = "patient-1-28y-NSAID-nogastro"
* gender = #male
...
Instance: patient-1-28y-NSAID-nogastro-medicationrequest-1
InstanceOf: MedicationRequest
* identifier
  * system = "http://cds.optum.com/fhir/test-cases|0.1.0"
  * value = "patient-1-28y-NSAID-nogastro-medicationrequest-1"
* status = #active
* intent = #order
...
* subject = Reference(patient-1-28y-NSAID-nogastro)
